        ...
        <>
          ...
          <main className="relative">
            ...
            <section id="sin-deficit">
              <div
                className="px-6 md:px-16 pt-16 pb-4 max-w-5xl mx-auto"
              >
                <div className="tva-label mb-2">Sección 01</div>
                <h2
                  className="text-3xl md:text-4xl font-bold uppercase tracking-[0.08em]"
                  style={{ color: "#FFF0DC" }}
                >
                  Compras Sin Déficit
                </h2>
                <div
                  ...
                  style={{ background: "rgba(255,240,220,0.35)" }}
                />
              </div>
              ...
              <ProblemaSection
                ...
                formulas={[
                  ...
                  "",
                  "CT = C₁·D + (C₂·D/Q) + (C₃·Q/2)",
                  "CT = (850×2,400) + (1,500×2,400/387.30) + (48×387.30/2)",
                  "CT = 2,040,000 + 9,295.16 + 9,295.16",
                  "CT = $2,058,590.32 por año",
                  "",
                  "N = D / Q = 2,400 / 387.30 = 6.20 ≈ 6 pedidos/año",
                  "t = (1/6.20) × 365 = 58.90 ≈ 59 días",
                ]}
                results={[
                  { label: "Cantidad Óptima Q",    value: "387 ton/pedido" },
                  { label: "Costo Total Anual CT", value: "$2,058,590.32" },
                  { label: "Pedidos por Año N",    value: "6 pedidos" },
                  { label: "Tiempo entre Pedidos", value: "59 días" },
                ]}
              ...
              <ProblemaSection
                ...
                formulas={[
                  ...
                  "Q = √166,400,000 = 12,899.61 ≈ 12,900 tornillos",
                  "",
                  "CT = C₁·D + (C₂·D/Q) + (C₃·Q/2)",
                  "CT = (0.45×156,000) + (320×156,000/12,899.61)",
                  "   + (0.60×12,899.61/2)",
                  "CT = 70,200 + 3,869.88 + 3,869.88",
                  "CT = $77,939.77 por año",
                  "",
                  "N = 156,000 / 12,899.61 = 12.09 ≈ 12 pedidos/año",
                  "t = (1/12.09) × 365 = 30.18 ≈ 30 días",
                ]}
                results={[
                  { label: "Cantidad Óptima Q",    value: "12,900 torn/pedido" },
                  { label: "Costo Total Anual CT", value: "$77,939.77" },
                  { label: "Pedidos por Año N",    value: "12 pedidos" },
                  { label: "Tiempo entre Pedidos", value: "30 días" },
                ]}
            ...
            >
              <div className="px-6 md:px-16 pt-16 pb-4 max-w-5xl mx-auto">
              ...
              <ProblemaSection
                ...
                planteamiento="NexTech almacena tanques de hidrógeno líquido (LH₂) para abastecer sus misiones. La demanda anual es de 18,000 tanques. El costo por déficit es de $80/tanque·año (penalización por retrasar un lanzamiento por falta de combustible). Se permite déficit moderado."
                datos={[
                ...
                formulas={[
                  "Q = √(2·C₂·D/C₃) × √((C₃+C₄)/C₄)",
                  "Q = √(2×2200×18000/25) × √(105/80)",
                  "Q = 1,779.89 × 1.1456 = 2,039.12 ≈ 2,039 tanques",
                  "",
                  "S = (C₃/(C₃+C₄)) × Q = (25/105) × 2,039.12",
                  "S = 485.50 ≈ 486 tanques agotados/ciclo",
                  "",
                  "IM = Q − S = 2,039.12 − 485.50 = 1,554 tanques",
                  "",
                  "CT = C₁·D + (C₂·D/Q) + C₃·(Q−S)²/(2Q) + C₄·S²/(2Q)",
                  "CT = 2,160,000 + 19,420.45 + 14,795.40 + 4,624.48",
                  "CT = $2,198,840.33 por año",
                  "",
                  "N = 18,000 / 2,039.12 = 8.83 ≈ 9 pedidos/año",
                  "t = 41.35 ≈ 41 días",
                ]}
                results={[
                  { label: "Cantidad Óptima Q",     value: "2,039 tanq/pedido" },
                  { label: "Unidades Agotadas S",   value: "486 tanques/ciclo" },
                  { label: "Inventario Máximo IM",  value: "1,554 tanques" },
                  { label: "Costo Total Anual CT",  value: "$2,198,840.33" },
                  { label: "Pedidos por Año N",     value: "9 pedidos" },
                  { label: "Tiempo entre Pedidos",  value: "41 días" },
                ]}
              ...
              <ProblemaSection
                ...
                planteamiento="NexTech integra paneles solares de arseniuro de galio en los satélites que lanza al espacio. La demanda bimestral es de 6,000 paneles. El costo de almacenamiento es de $2.80/mes (sala limpia clase 10,000) y el costo por déficit es de $95/panel por semestre (penalización por retraso en entrega del satélite)."
                datos={[
                ...
                formulas={[
                  "Q = √(2·C₂·D/C₃) × √((C₃+C₄)/C₄)",
                  "Q = √(2×4500×36000/33.60) × √(223.60/190)",
                  "Q = 3,105.30 × 1.0848 = 3,368.70 ≈ 3,369 paneles",
                  "",
                  "S = (C₃/(C₃+C₄)) × Q = (33.60/223.60) × 3,368.70",
                  "S = 506.21 ≈ 506 paneles agotados/ciclo",
                  "",
                  "IM = Q − S = 3,368.70 − 506.21 = 2,862 paneles",
                  "",
                  "CT = C₁·D + (C₂·D/Q) + C₃·(Q−S)²/(2Q) + C₄·S²/(2Q)",
                  "CT = 6,660,000 + 48,083.55 + 40,847.95 + 7,248.13",
                  "CT = $6,756,179.62 por año",
                  "",
                  "N = 36,000 / 3,368.70 = 10.69 ≈ 11 pedidos/año",
                  "t = 34.15 ≈ 34 días",
                ]}
                results={[
                  { label: "Cantidad Óptima Q",    value: "3,369 pan/pedido" },
                  { label: "Unidades Agotadas S",  value: "506 paneles/ciclo" },
                  { label: "Inventario Máximo IM", value: "2,862 paneles" },
                  { label: "Costo Total Anual CT", value: "$6,756,179.62" },
                  { label: "Pedidos por Año N",    value: "11 pedidos" },
                  { label: "Tiempo entre Pedidos", value: "34 días" },
                ]}
